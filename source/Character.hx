...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bob-halloween':
				tex = Paths.getSparrowAtlas('bob','shared/halloween');
				frames = tex;
				...
				playAnim('idle');
			case 'ron-halloween':
				tex = Paths.getSparrowAtlas('ron','shared/halloween');
				frames = tex;
				animation.addByPrefix('idle', 'RON_idle', 24);
				animation.addByPrefix('deathlol', 'RON_dead', 24);
				animation.addByPrefix('mischievousidle', 'RON_mischievous_idle', 24);
				animation.addByPrefix('singUP', 'Ronup', 24);
				animation.addByPrefix('singRIGHT', 'Ronright', 24);
				animation.addByPrefix('singDOWN', 'Rondown', 24);
				animation.addByPrefix('singLEFT', 'Ronleft', 24);

				addOffset('idle');
				addOffset('deathlol', 71, -40);
				addOffset('mischievousidle');
				addOffset("singUP", -6, 50);
				addOffset("singRIGHT", 0, 27);
				addOffset("singLEFT", -10, 10);
				addOffset("singDOWN", 0, -30);
				...
				playAnim('idle');
			case 'little-man-halloween':
					tex = Paths.getSparrowAtlas('little-man','shared/halloween');
					frames = tex;
					animation.addByPrefix('idle', 'idle', 24);
